...
public class ContainsParameterAnnotationTest {
	...
	public void getParameterAnnotationIndexException() throws Exception{
		...
		new AssertException(ParameterAnnotationNotFoundException.class, "The method method1 has no parameter with net.sf.esfinge.querybuilder.annotation.Starts annotation") {
			protected void run() {
