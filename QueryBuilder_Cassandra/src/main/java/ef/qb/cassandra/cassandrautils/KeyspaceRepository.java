...
import ef.qb.cassandra.exceptions.InvalidNumberOfReplicasException;
...
public class KeyspaceRepository {
     ...
     * @param replicationStrategy the replication strategy, either SimpleStrategy or NetworkTopologyStrategy
    ...
    /**
     * Method used to delete the specified schema. It results in the immediate, irreversible removal of the keyspace,
