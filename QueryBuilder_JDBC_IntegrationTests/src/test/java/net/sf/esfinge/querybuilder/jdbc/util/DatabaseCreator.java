...
public class DatabaseCreator {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("Operation: the table PERSON does not exist, so will be created");
			;
		}
		...
		try {
			...
			System.out.println("Operation: the table ADDRESS does not exist, so will be created");
			;
		}
		...
		try {
			...
			System.out.println("Operation: the table WORKER does not exist, so will be created");
			;
		}
