package net.sf.esfinge.querybuilder.jdbc.queryobject;
...
public class QueryBuilderJPAQueryObject {
	
	private TestQueryObject tq;

	@Before
	public void setupDatabase() throws Exception {
		new DataBaseCommunicator().initializeDatabase("/initial_db_queryobject.xml");
