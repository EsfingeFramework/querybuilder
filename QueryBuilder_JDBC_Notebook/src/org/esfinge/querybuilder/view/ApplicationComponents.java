package org.esfinge.querybuilder.view;
...
public class ApplicationComponents extends JFrame {
	...
	private JLabel lblContactStreetComplement = new JLabel(
			"Street Complement : ");
	...
	private JButton btnNewContact = new JButton("New", new ImageIcon(
			"./images/new.png"));
	private JButton btnSaveContact = new JButton("Save", new ImageIcon(
			"./images/save.png"));
	private JButton btnCancelContact = new JButton("Cancel", new ImageIcon(
			"./images/cancel.png"));
	private JButton btnDeleteContact = new JButton("Delete", new ImageIcon(
			"./images/delete.png"));
	private JButton btnSearch = new JButton("Search", new ImageIcon(
			"./images/search.png"));

	private JButton btnCloseApplication = new JButton("Close", new ImageIcon(
			"./images/exit.png"));

	private JButton btnModifyContact = new JButton("Modify", new ImageIcon(
			"./images/modify.png"));

	private JButton btnGoSearch = new JButton("Go Search", new ImageIcon(
			"./images/ok.png"));

	private JButton btnSearchFriends = new JButton("Friends", new ImageIcon(
			"./images/cell.png"));
