...
import net.sf.esfinge.querybuilder.model.persistence.AddressOperations;
import net.sf.esfinge.querybuilder.model.persistence.ContactOperations;
import net.sf.esfinge.querybuilder.model.persistence.PersonOperations;
import net.sf.esfinge.querybuilder.util.DatabaseHSQLDBShutdown;
import net.sf.esfinge.querybuilder.view.ApplicationView;
